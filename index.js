...
const dialogs = document.querySelectorAll('#starting-dialogs dialog')
const dialogBtns = document.querySelectorAll('#starting-dialogs dialog button')
const dialogInput = []
...
for (let i = 0; i < dialogBtns.length; ++i)
{
    ...
    if (i === dialogBtns.length - 1)
    {
        ...
        dialogBtns[i].addEventListener('click', (e) =>
        {
            ...
            playerNameArea.textContent = dialogInput[0]
...
function playGame()
{
    ...
    const player = new Player(dialogInput[0], STARTING_CHIPS, 'khorne')
